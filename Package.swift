...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "KYCAIDSDK",
            url: "https://github.com/kycaid/ios-sdk/releases/download/25.10.1/KYCAIDSDK.xcframework.zip",
            checksum: "8372ef00c591b129567d94034bfa66ad1eaf85714ed91d04f25b59eb43fff864"
        ),
        .target(
            name: "KycaidSDKSwift",
            dependencies: [
