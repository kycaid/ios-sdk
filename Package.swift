...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "KYCAIDSDK",
            url: "https://github.com/kycaid/ios-sdk/releases/download/25.12.0/KYCAIDSDK.xcframework.zip",
            checksum: "61bacb3234e3f95a20cf36716be4f9bfc9e44f31d5fc3cc723bb4f0dd66b283f"
        ),
        .target(
            name: "KycaidSDKSwift",
            dependencies: [
