...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "KYCAIDSDK",
            url: "https://github.com/kycaid/ios-sdk/releases/download/25.9.7/KYCAIDSDK.xcframework.zip",
            checksum: "1cfc5265560cb72e3e30a2621aa576234828a0b167043fbd50e602b1a04f6c9e"
        ),
        .target(
            name: "KYCAID",
            dependencies: [
