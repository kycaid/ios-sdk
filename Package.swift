...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "KYCAIDSDK",
            url: "https://github.com/kycaid/ios-sdk/releases/download/25.11.1/KYCAIDSDK.xcframework.zip",
            checksum: "1946bfa1b33df6e7e57f5ba7520ec3b06c66bc0a5e9730c2fc86fbb32781181f"
        ),
        .target(
            name: "KycaidSDKSwift",
            dependencies: [
